...
parser.add_argument('--csv_path', type=str,default = '/raid/Aditya/Recon/Tumor/Recon/modl2D/FLAIR_EROTC_2D_TEST_ALL_TIME_NAS.csv')
...
model_path = dir+'FLAIR_2D_dcdw/R'+str(R_in)+'/'
if R_in == 2:
    subDirectory='08May_1048am_5L_10K_100E_AG'
elif R_in == 4:
    subDirectory='08May_0208pm_5L_10K_100E_AG'
elif R_in == 6:
    subDirectory='08May_0858pm_5L_10K_100E_AG'
elif R_in == 8:
    subDirectory='09May_0952am_5L_10K_100E_AG'
elif R_in == 10:
    subDirectory='09May_0454pm_5L_10K_100E_AG'
elif R_in == 15:
    subDirectory='12Jul_1135am_5L_10K_100E_AG'
