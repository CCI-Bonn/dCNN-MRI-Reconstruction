...
**Testing**: MRI exams from patients with glioblastoma in the EORTC-26101 phase II and III trial (528 patients with 1974 MRI exams from 32 institutions all containing pre- and postcontrast T1-w, T2-w and FLAIR sequences) and from subjects in the public fastMRI brain test dataset (558 subjects with 558 exams from 5 institutions) were used for testing. In the fastMRI dataset, the most prevalent categories are 'Normal for age' (45%), 'Nonspecific white matter lesion' (12%), and 'Mass lesion' (6%) (a complete list of categories is available in the appendix of the manuscript).
